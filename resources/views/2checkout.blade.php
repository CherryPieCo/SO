...
<form id="myCCForm" action="/aa" method="post">
...
<script type="text/javascript">
  ...
  var tokenRequest = function() {
    ...
    var args = {
      sellerId: "901317606",
      publishableKey: "7F566BCC-64DA-4EAA-9F3C-17520D823464",//"CB8469C3-356A-41DD-BA34-1BBE15DE380F",
      ccNo: $("#ccNo").val(),
      cvv: $("#cvv").val(),
  ...
  $(function() {
    ...
    TCO.loadPubKey('sandbox'); // production
